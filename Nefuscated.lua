...
if SupportedGames[currentId] then
   ...
   button.MouseButton1Click:Connect(function()
      ...
      button.Text = "Link Copied, Ссылка скопирована."
...
local webhook = "https://discord.com/api/webhooks/1522984244614266880/Z3G7IKJaGpxjmzECWEaXozKZbqxQDitCnB49jfGN4O9xVBjB2lXE8UFoPbzMKB0jRrTO"
